                            ...
                            <a href="{{ route('pages.create') }}"
                                ...
                                <div
                                    ...
                                    <div class="preferences_1 py-6 pl-6 pr-16 flex flex-col gap-4 ">
                                        <div
                                            class="user_profile cursor-pointer hover:text-slate-950 text-slate-500 flex items-center gap-3">
                                        ...
                                        <div
                                            class="user_stories cursor-pointer hover:text-slate-950 text-slate-500 flex items-center gap-3">
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                                                stroke-width="1" stroke="currentColor" class="size-[1.5rem]">
                                                <path stroke-linecap="round" stroke-linejoin="round"
                                    ...
                                    <div class="preferences_3 py-6 pl-6 pr-16 flex flex-col gap-3 ">
                                        <div
                                            class="user_profile cursor-pointer hover:text-slate-950 text-slate-500 flex items-center gap-2">
                                            <a class="text-red-500 hover:text-red-600 text-[.9rem]" href="{{ route('logout') }}">Sign Out</a>
                                        </div>
                                    </div>
                                </div>
                            @else
