                ...
                <a href="{{ route('pages.post', ['id' => $post->id]) }}"
                    ...
                    <div class="header-card flex flex-row-reverse items-center justify-between">
                        ...
                        <div class="like-btn flex items-center gap-2">
                            <svg class="max-sm:w-5 w-6 h-6 max-sm:h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                            ...
                            <p class="max-sm:text-sm">12.4K</p>
                        </div>

                        <div class="creator flex gap-2 items-center">
                            <div class="pp max-sm:w-7 max-sm:h-7 w-10 h-10 rounded-full bg-slate-400"></div>
                            <p class="name max-sm:text-sm font-bold text-[1rem]">@ {{ $post->username }}</p>
                        </div>
                    </div>
